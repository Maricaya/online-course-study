...
0000000000400efc <phase_2>:
  ...
  *0x400f0a:	83 3c 24 01          	cmpl   $0x1,($rsp)
  400f0e:	74 20                	je     400f30 <phase_2+0x34>
  400f10:	e8 25 05 00 00       	callq  40143a <explode_bomb>
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax
  400f1a:	01 c0                	add    $eax,%eax
  *0x400f1c:	39 03                	cmp    $eax,($rbx)
  400f1e:	74 05                	je     400f25 <phase_2+0x29>
  400f20:	e8 15 05 00 00       	callq  40143a <explode_bomb>
  400f25:	48 83 c3 04          	add    $0x4,%rbx
  400f29:	48 39 eb             	cmp    %rbp,%rbx
  400f2c:	75 e9                	jne    400f17 <phase_2+0x1b>
  *0x400f2e:	eb 0c                	jmp    400f3c <phase_2+0x40>
  *0x400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx
...
0000000000400f43 <phase_3>:
  *0x400f43:	48 83 ec 18          	sub    $0x18,$rsp :: 'w'
  *0x400f47:	48 8d 4c 24 0c       	lea    0xc($rsp),$rcx : 13
  *0x400f4c:	48 8d 54 24 08       	lea    0x8($rsp),$rdx: 3
  *0x400f51:	be cf 25 40 00       	mov    $0x4025cf,$esi :// 52 '4' 这是 input
  *0x400f56:	b8 00 00 00 00       	mov    $0x0,$eax // 0
  *0x400f5b:	e8 90 fc ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  *0x400f60:	83 f8 01             	cmp    $0x1,$eax// 1 ???
  *0x400f63:	7f 05                	jg     400f6a <phase_3+0x27>
  *0x400f65:	e8 d0 04 00 00       	callq  40143a <explode_bomb>
  *0x400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8($rsp) // '006'
  *0x400f6f:	77 3c                	ja     400fad <phase_3+0x6a>
  *0x400f71:	8b 44 24 08          	mov    0x8($rsp),$eax// 2
  *0x400f75:	ff 24 c5 70 24 40 00 	jmpq   *0x402470(,%rax,8) //rax 4
  *0x400f7c:	b8 cf 00 00 00       	mov    $0xcf,%eax
  *0x400f81:	eb 3b                	jmp    400fbe <phase_3+0x7b> //
  *0x400f83:	b8 c3 02 00 00       	mov    $0x2c3,%eax      // ??
  *0x400f88:	eb 34                	jmp    400fbe <phase_3+0x7b> //
  *0x400f8a:	b8 00 01 00 00       	mov    $0x100,%eax
  *0x400f8f:	eb 2d                	jmp    400fbe <phase_3+0x7b> //
  *0x400f91:	b8 85 01 00 00       	mov    $0x185,%eax
  *0x400f96:	eb 26                	jmp    400fbe <phase_3+0x7b>//
  *0x400f98:	b8 ce 00 00 00       	mov    $0xce,%eax
  *0x400f9d:	eb 1f                	jmp    400fbe <phase_3+0x7b>
  *0x400f9f:	b8 aa 02 00 00       	mov    $0x2aa,$eax  // 跳转到这里了 $eax 6
  *0x400fa4:	eb 18                	jmp    400fbe <phase_3+0x7b>
  *0x400fa6:	b8 47 01 00 00       	mov    $0x147,%eax  // ??
  *0x400fab:	eb 11                	jmp    400fbe <phase_3+0x7b>
  *0x400fad:	e8 88 04 00 00       	callq  40143a <explode_bomb>
  *0x400fb2:	b8 00 00 00 00       	mov    $0x0,%eax
  *0x400fb7:	eb 05                	jmp    400fbe <phase_3+0x7b>
  *0x400fb9:	b8 37 01 00 00       	mov    $0x137,%eax
  *0x400fbe:	3b 44 24 0c          	cmp    0xc($rsp),$eax
  *0x400fc2:	74 05                	je     400fc9 <phase_3+0x86>
  *0x400fc4:	e8 71 04 00 00       	callq  40143a <explode_bomb>
  *0x400fc9:	48 83 c4 18          	add    $0x18,%rsp // ""
  *0x400fcd:	c3                   	retq

0000000000400fce <func4>:
  *0x400fce:	48 83 ec 08          	sub    $0x8,$rsp

  *0x400fd2:	89 d0                	mov    $edx,$eax // 14 2
  *0x400fd4:	29 f0                	sub    $esi,$eax // 0 13
  *0x400fd6:	89 c1                	mov    $eax,$ecx // 14 32
  *0x400fd8:	c1 e9 1f             	shr    $0x1f,$ecx //将 $ecx 逻辑右移 31 位，保留符号位 - 0
  *0x400fdb:	01 c8                	add    $ecx,$eax // 0 14

  *0x400fdd:	d1 f8                	sar    $eax // 算术右移 %eax，即除以 2 -> 7
  *0x400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx // ??
  *0x400fe2:	39 f9                	cmp    %edi,%ecx
  *0x400fe4:	7e 0c                	jle    400ff2 <func4+0x24>
  *0x400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx
  *0x400fe9:	e8 e0 ff ff ff       	callq  400fce <func4>

  *0x400fee:	01 c0                	add    %eax,%eax
  *0x400ff0:	eb 15                	jmp    401007 <func4+0x39>
  *0x400ff2:	b8 00 00 00 00       	mov    $0x0,%eax
  *0x400ff7:	39 f9                	cmp    %edi,%ecx
  *0x400ff9:	7d 0c                	jge    401007 <func4+0x39>
  *0x400ffb:	8d 71 01             	lea    0x1(%rcx),%esi

  *0x400ffe:	e8 cb ff ff ff       	callq  400fce <func4>
  *0x401003:	8d 44 00 01          	lea    0x1(%rax,%rax,1),%eax
  *0x401007:	48 83 c4 08          	add    $0x8,%rsp
  *0x40100b:	c3                   	retq

000000000040100c <phase_4>:
  *0x40100c:	48 83 ec 18          	sub    $0x18,$rsp // "\223\016@"
  *0x401010:	48 8d 4c 24 0c       	lea    0xc($rsp),$rcx // 2
  *0x401015:	48 8d 54 24 08       	lea    0x8(%rsp),$rdx // 4
  *0x40101a:	be cf 25 40 00       	mov    $0x4025cf,$esi // '12'
  *0x40101f:	b8 00 00 00 00       	mov    $0x0,$eax //
  *0x401024:	e8 c7 fb ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  *0x401029:	83 f8 02             	cmp    $0x2,$eax
  *0x40102c:	75 07                	jne    401035 <phase_4+0x29>
  *0x40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp)

  *0x401033:	76 05                	jbe    40103a <phase_4+0x2e>
  *0x401035:	e8 00 04 00 00       	callq  40143a <explode_bomb>
  *0x40103a:	ba 0e 00 00 00       	mov    $0xe,$edx // 14
  *0x40103f:	be 00 00 00 00       	mov    $0x0,$esi // 0
  *0x401044:	8b 7c 24 08          	mov    0x8($rsp),$edi // 第一个输入的值

  *0x401048:	e8 81 ff ff ff       	callq  400fce <func4>
  *0x40104d:	85 c0                	test   %eax,%eax
  *0x40104f:	75 07                	jne    401058 <phase_4+0x4c>
  *0x401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp)
  *0x401056:	74 05                	je     40105d <phase_4+0x51>
